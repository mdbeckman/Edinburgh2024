...
#### Two question survey before seminar 

![(QR Code) https://forms.gle/hpW72fMYE1SsB19JA](QR-GForm.png){width=15%}

<!-- MDB: Update survey conclusion with pointer to TEMSE materials or personal webpage? -->
...
<!-- MDB: Revisit using the intro from the UoA lightning talk. -->
...
<!-- MDB: update to align with LT approach -->
...
### Pilot Study & Follow-Up Investigation
...
![Lloyd et al., (2022) Pilot Project Team](Collaborators.png){width=75%}
...
12. Pearl, D. K., Garfield, J. B., delMas, R., Groth, R. E., Kaplan, J. J., McGowan, H., & Lee, H. S. (2012). Connecting Research to Practice in a Culture of Assessment for Introductory College-level Statistics. URL: <http://www.causeweb.org/research/guidelines/ResearchReport_Dec_2012.pdf>
